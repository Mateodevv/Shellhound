      ...
      <div className="min-h-0 flex-1 overflow-y-auto pr-2">
        <div className="mx-auto flex max-w-3xl flex-col gap-4">
          ...
          {current === 'case' && <>
            ...
            <CtiField label={`${tr('cti.caseId')}${configured ? ' *' : ''}`}><input required={configured} maxLength={200} placeholder="SYN-2026-001" className={ctiInput} value={reference} onChange={e => setReference(e.target.value)} /></CtiField>
