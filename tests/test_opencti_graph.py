...
class OpenCTIGraphTests(unittest.TestCase):
    def setUp(self):
        ...
        self.case = workspace.create_case(self.root / "cases", "Never export customer name", "SYN-2026-001")
    ...
    def test_withdrawal_revokes_only_disappeared_own_assertions(self):
        ...
        foreign = {"id": "malware--external", "type": "malware", "created_by_ref": "identity--other",
                   "x_shellhound_case_reference": "SYN-2026-001"}
        withdrawn = graph.withdrawal_objects(previous + [foreign], current, "SYN-2026-001")
    ...
    def test_reconfirmation_creates_stable_new_generation_without_unrevoking_history(self):
        ...
        withdrawn = graph.withdrawal_objects(original, reduced, "SYN-2026-001")
    ...
    def test_manual_classification_change_replaces_old_assertion_and_updates_ioc_status(self):
        ...
        revoked = graph.withdrawal_objects(webshell["objects"], malware["objects"], "SYN-2026-001")
    ...
    def test_observables_have_clear_case_descriptions_and_explicit_incident_relationships(self):
        ...
        for obj in observables:
            ...
            self.assertIn("SYN-2026-001", text)
