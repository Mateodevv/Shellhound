...
CATALOGUE: dict[str, str] = {
    ...
    "chain.file.lastOk": "Last request for {name} answered 2xx",
    ...
    "chain.hunt.last": "Last selected Pattern Hunt match from {ip}",
    "chain.hunt.detail": "{method} {uri} · {status}; selected Pattern Hunt evidence. An HTTP response alone does not establish successful exploitation.",
